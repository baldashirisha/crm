# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2020-05-15 07:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Lead', 'Lead'), ('Opportunity', 'Opportunity'), ('Customer/won', 'Customer/won'), ('Archive', 'Archive')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Notes',
            fields=[
                ...
                ('Contact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Contact')),
            ],
        ),
        migrations.CreateModel(
            name='roles',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('roles_status', models.CharField(choices=[('Sales_rep', 'Sales_rep'), ('Sales_manager', 'Sales_manager'), ('Admin', 'Admin')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='task_status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive'), ('Pending_approval', 'Pending_approval')], max_length=20)),
            ],
        ),
        migrations.AddField(
            model_name='notes',
            name='Task_Status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.task_status'),
        ),
        migrations.AddField(
            model_name='notes',
            name='Todo_Desc_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.todo_desc'),
        ),
        migrations.AddField(
            model_name='notes',
            name='Todo_Type_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.todo_type'),
        ),
        migrations.AddField(
            model_name='contact',
            name='status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Contact_Status'),
        ),
        migrations.AddField(
            model_name='user',
            name='User_Roles',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.roles'),
        ),
        migrations.AddField(
            model_name='user',
            name='User_Status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.user_status'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
